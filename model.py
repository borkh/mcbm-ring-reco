...
def VGG16_mod(input_shape, output_shape, config=None):
    ...
    # block1
    t = Conv2D(16, 3, padding="same", activation="relu", name="block1_conv1")(t)
    t = Conv2D(16, 3, padding="same", activation="relu", name="block1_conv2")(t)
    t = MaxPooling2D((2,2), padding="same", name="block1_pool")(t)

    # block2
    t = Conv2D(32, 3, padding="same", activation="relu", name="block2_conv1")(t)
    t = Conv2D(32, 3, padding="same", activation="relu", name="block2_conv2")(t)
    t = MaxPooling2D((2,2), padding="same", name="block2_pool")(t)

    # block3
    t = Conv2D(64, 3, padding="same", activation="relu", name="block3_conv1")(t)
    t = Conv2D(64, 3, padding="same", activation="relu", name="block3_conv2")(t)
    t = Conv2D(64, 3, padding="same", activation="relu", name="block3_conv3")(t)
    t = MaxPooling2D((2,2), padding="same", name="block3_pool")(t)

    # block4
    t = Conv2D(128, 3, padding="same", activation="relu", name="block4_conv1")(t)
    t = Conv2D(128, 3, padding="same", activation="relu", name="block4_conv2")(t)
    t = Conv2D(128, 3, padding="same", activation="relu", name="block4_conv3")(t)
