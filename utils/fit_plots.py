...
cnn_fit = np.array([plot_single_event(x, y1) for x,y1 in zip(sim[500:1000], cnn1[500:1000])])

cnn_vs_idealhough = np.array([plot_single_event(x,y1,y2) for x,y1,y2 in zip(sim[500:1000], cnn1[500:1000], idealhough[500:1000])])
cnn_vs_hough = np.array([plot_single_event(x,y1,y2) for x,y1,y2 in zip(sim[:500], cnn1[:500], hough[:500])])
