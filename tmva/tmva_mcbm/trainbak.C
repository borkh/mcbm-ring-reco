...
void train(){
    ...
    TFile* data = TFile::Open("mcbm_normalized.root");
    ...
    TString batchLayoutString = "BatchLayout=100|1|2304:";
    ...
    TString cnnOptions = "H:V:VarTransform=None:ErrorStrategy=CROSSENTROPY:VerbosityLevel=Debug:Architecture=GPU";
