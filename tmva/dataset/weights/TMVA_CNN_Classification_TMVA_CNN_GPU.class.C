...
Method         : DL::TMVA_CNN_GPU
TMVA Release   : 4.2.1         [262657]
ROOT Release   : 6.26/02       [399874]
Creator        : robin
Date           : Fri May 13 12:23:23 2022
...
class ReadTMVA_CNN_GPU : public IClassifierReader {

 public:

   // constructor
   ReadTMVA_CNN_GPU( std::vector<std::string>& theInputVars )
      : IClassifierReader(),
        fClassName( "ReadTMVA_CNN_GPU" ),
        fNvars( 256 )
   {
...
inline double ReadTMVA_CNN_GPU::GetMvaValue( const std::vector<double>& inputValues ) const
{
